...
- runtime package resources also carry parsed GM font atlas images and glyph metrics, and text draw commands preserve resolved font name, size, bold, and italic fields through the WASM/browser render path
