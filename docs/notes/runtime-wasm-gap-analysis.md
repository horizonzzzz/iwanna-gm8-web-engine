...
- Parser exports GM font metadata into `resources/index.json`, runtime-core resolves lowered `draw_set_font(...)`, and the WASM/browser frame path carries font name, size, bold, and italic flags for package-owned text drawing.
